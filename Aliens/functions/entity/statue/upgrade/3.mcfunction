setblock 10002 5 10007 stone
tag @e[type=chum:sea_junk_statue] add do_upgrade_3
summon chum:upgrade_particle 201 66 44 chum:statue_upgrade_3
scoreboard objectives add statue_upg dummy
scoreboard players set @e[name=main] statue_upg 0
execute @e[type=chum:sea_junk_statue,tag=do_upgrade_1,c=1] ~~~ scoreboard players add @e[name=main] statue_upg 1
