...
scoreboard players set @e[type=shapescape:ray_dummy,c=1] ray_age 100

execute @e[type=shapescape:ray_dummy,c=1] ~ ~ ~ function weapons/ranged/omni_gun/freeze/ray_tick
